  ...
  return (
    <div className="relative w-full h-[80vh] flex flex-col justify-center items-center text-center px-6  bg-gradient-to-r overflow-hidden from-black via-gray-900 to-black">
      ...
      <motion.p
        ...
        className="text-lg md:text-xl max-w-2xl mt-15 text-white relative z-10"
      >
        Access freely available PDF notes from across the internet. Contribute your own handwritten notes & help others learn!
      </motion.p>
      ...
      <motion.div
        ...
        className="flex gap-4 mt-20 relative z-10"
      >
        <motion.button
